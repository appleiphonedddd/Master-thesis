...
datasets = ['MNIST','KMNIST' ,'FMNIST', 'CIFAR10', 'CIFAR100', 'Tiny-ImageNet', 'Stanford Dogs']
accuracy = [
    [98.18,95.89, 85.80, 56.68, 32.69,19.50,7.66],  # FedAvg
    [99.65,99.17, 97.57, 89.90, 49.97,35.50,25.44],  # FedDodm
    [99.68,98.92, 97.74, 91.55, 59.62,40.06,28.92],  # FedAS
    [99.25,97.92, 97.36, 89.55, 46.82,26.92,np.nan]   # DCPFL
]
