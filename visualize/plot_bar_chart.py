...
def plot_accuracy_comparison(methods, datasets, accuracy):
    ...
    for i, method in enumerate(methods):
        ax.bar(x + i*width, accuracy[i], width, label=method)
    ...
    print("[Info] Saved accuracy comparison plot to Result.png")
...
accuracy = [
    ...
    [99.25, 97.36, 89.55, 46.82, np.nan]  # DCPFL
]

plot_accuracy_comparison(methods, datasets, accuracy)
