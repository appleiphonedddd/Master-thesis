...
COLOR_FEDAVG = "#FF7F0E"  # FedAvg
COLOR_FEDAS  = "blue"     # FedAS
COLOR_DCPFL  = "red"      # DCPFL
COLOR_DODM   = "green"    # FedDodm

def plot_dataset(title, fedavg, fedas, fiddodm, dcpfl, fname=None):
    plt.figure(figsize=(16, 8))
    plt.bar(x - 1.5*bar_width, fedavg, width=bar_width, label="FedAvg", color=COLOR_FEDAVG)
    plt.bar(x - 0.5*bar_width, fedas,  width=bar_width, label="FedAS",  color=COLOR_FEDAS)
    plt.bar(x + 0.5*bar_width, fiddodm, width=bar_width, label="FedDodm", color=COLOR_DODM)
    plt.bar(x + 1.5*bar_width, dcpfl, width=bar_width, label="DCPFL", color=COLOR_DCPFL)
    plt.xticks(x, clients, rotation=45)
    plt.ylabel("Accuracy (%)")
    plt.title(title)
    plt.legend()
    plt.tight_layout()
...
plot_dataset("Client Accuracy on MNIST across Algorithms", FedAvg, FedAS, FedDodm, DCPFL, fname="MNIST.png")
...
plot_dataset("Client Accuracy on FMNIST across Algorithms", FedAvg_FMNIST, FedAS_FMNIST, FedDodm_FMNIST, DCPFL_FMNIST, fname="FMNIST.png")
...
plot_dataset("Client Accuracy on CIFAR10 across Algorithms", FedAvg_C10, FedAS_C10, FedDodm_C10, DCPFL_C10, fname="CIFAR10.png")
...
plot_dataset("Client Accuracy on CIFAR100 across Algorithms", FedAvg_C100, FedAS_C100, FedDodm_C100, DCPFL_C100, fname="CIFAR100.png")
...
plot_dataset("Client Accuracy on Tiny-ImageNet across Algorithms", FedAvg_Tiny, FedAS_Tiny, FedDodm_Tiny, DCPFL_Tiny, fname="TINTIMAGENET.png")